...
// Source: github.com/roidmc/kexcore-oidc/pkg/op (interfaces: Client)
...
func (m *MockClient) AuthMethod() protocol.AuthMethod {
	m.ctrl.T.Helper()
...
func (m *MockClient) GrantTypes() []protocol.GrantType {
	m.ctrl.T.Helper()
